...
class ReadType06Uint16Test < Minitest::Test
	...
	def test_reads_one_uint16_channel_in_one_segment
		...
		assert_equal TDMS::DataTypes::UInt16::ID, doc.segments[0].objects[0].data_type_id
	...
	def test_reads_two_uint16_channels_in_one_segment
		...
		assert_equal TDMS::DataTypes::UInt16::ID, doc.segments[0].objects[0].data_type_id
		assert_equal TDMS::DataTypes::UInt16::ID, doc.segments[0].objects[1].data_type_id

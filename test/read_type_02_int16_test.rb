...
class ReadType02Int16Test < Minitest::Test
	...
	def test_reads_one_int16_channel_in_one_segment
		...
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[0].objects[0].data_type_id
	...
	def test_reads_two_int16_channels_in_one_segment
		...
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[0].objects[0].data_type_id
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[0].objects[1].data_type_id
	...
	def test_reads_one_int16_channel_across_three_segments
		...
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[0].objects[0].data_type_id
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[1].objects[0].data_type_id
		assert_equal TDMS::DataTypes::Int16::ID, doc.segments[2].objects[0].data_type_id
